...
class AppRouter {
  ...
  static final List<GoRoute> _controlPanelRoutes = [
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) {
        return slideTransition(
            context: context, state: state, child: const EditProfilePage());
      },
    ),
    GoRoute(
      ...
      pageBuilder: (context, state) {
        return slideTransition(
            context: context, state: state, child: RestrictionsPage());
      },
      routes: [
        GoRoute(
          ...
          pageBuilder: (context, state) {
            return slideTransition(
                context: context, state: state, child: AddRestrictionPage());
          },
        ),
      ],
    ),
