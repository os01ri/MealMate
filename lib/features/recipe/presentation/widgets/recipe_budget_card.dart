...
class _RecipeBudget extends StatelessWidget {
  final int price, stepsCount;
  final ValueNotifier<int> persons;
                      ...
                      Row(
                        ...
                        children: [
                          const Icon(Icons.remove).onTap(() {
                            if (value > 1) persons.value--;
                          }),
                          Text('$value').paddingHorizontal(12),
                          const Icon(Icons.add).onTap(() => persons.value++),
                        ],
                      ).expand(),
                    ],
                  ).expand(),
